...
import { DataTablePagination } from "@/components/data-table-server/components/data-table-pagination";
import {
  Table,
  TableBody,
  TableCell,
...
import { getCommonPinningStyles } from "@/components/data-table-server/lib/data-table";
