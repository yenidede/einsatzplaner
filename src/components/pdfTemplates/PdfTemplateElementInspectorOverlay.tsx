...
interface PdfTemplateElementInspectorOverlayProps {
...
export const PdfTemplateElementInspectorOverlay = memo(function PdfTemplateElementInspectorOverlay({
  selectedElement,
  fields,
  onClose,
  onMoveStart,
...
}: PdfTemplateElementInspectorOverlayProps) {
  return (
