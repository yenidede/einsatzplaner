...
import { AlertCircleIcon, CloudUpload, File as FileIcon, XIcon } from 'lucide-react'
...
export function FileUpload<TFieldName extends string>({
	...
	const [
		...
		accept,
		onFilesChange: (files) => {
			const uploadedFiles = files.reduce<File[]>((accumulator, file) => {
				if (file.file instanceof File) {
					accumulator.push(file.file)
				}
				return accumulator
			}, [])
			setValue(
