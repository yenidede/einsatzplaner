              ...
              >
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Verwalte E-Mail-Benachrichtigungen für deine
                      Organisationen
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
              ...
              >
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>
                      Abonniere Kalender deiner Organisationen in externen Apps
                    ...
                    {organizations.length > 0 ? (
                        ...
                        <div className="bg-muted/50 rounded-lg p-4">
                          ...
                          <ol className="text-muted-foreground space-y-2 text-sm">
                            ...
                            <li className="flex gap-2">
                              ...
                              Füge die URL in deiner Kalender-App als Abonnement
                              hinzu
                            </li>
                            <li className="flex gap-2">
                              <span className="bg-primary/10 text-primary flex h-5 w-5 shrink-0 items-center justify-center rounded-full text-xs font-medium">
                              ...
                              Dein Kalender synchronisiert automatisch alle
                              Ereignisse
                            </li>
                          </ol>
                        </div>
                      ...
                      <div className="flex flex-col items-center justify-center rounded-lg border border-dashed py-12 text-center">
                        ...
                        <p className="text-muted-foreground mt-1 text-xs">
                          Kalender-Integrationen werden verfügbar, sobald du
                          einer Organisation beitrittst.
                        </p>
                      </div>
                    )}
                  </CardContent>
