...
export async function GET(request: NextRequest) {
  try {
    ...
    const organizations: OrganizationUser[] = user.user_organization_role.map(uor => ({
    ...
    const userData: AuthUser = {
      ...
      allPermissions: [...new Set(organizations.flatMap(org => org.permissions))], // Unique permissions
    };
