...
export default function CalendarSubscription({
  ...
  return (
    <div className={container}>
      ...
      <div
        className="bg-muted/50 hover:bg-muted/70 mt-2 cursor-pointer rounded p-2 text-[13px] break-all transition-colors select-none"
        onClick={copy}
      ...
      <div className="mt-2 flex flex-wrap gap-2">
        <button className="rounded border px-3 py-1.5 text-xs" onClick={copy}>
          URL kopieren
        </button>
