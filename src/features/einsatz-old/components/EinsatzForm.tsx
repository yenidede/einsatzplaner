...
import {
  useEinsatz,
  useAutosave,
} from "@/features/einsatz-old/hooks/useEinsatz";
import { checkHelferWarning } from "@/utils/einsatzClientUtils";
import {
  exampleTemplates,
  EinsatzTemplate,
} from "@/features/einsatztemplate/types/einsatzTemplate";
...
export default function EinsatzForm({
  ...
  const [selectedTemplate, setSelectedTemplate] =
    useState<EinsatzTemplate | null>(null);
  ...
  const kategorieOptions = ["Freizeit (KiJu)", "Rüstzeuge (KiJu)", "Sonstiges"];
        ...
        <div className="self-stretch flex flex-col justify-center items-start gap-4">
          <div className="self-stretch px-4 inline-flex justify-start items-start gap-4">
            <div className="flex-1 inline-flex flex-col justify-start items-start gap-1.5">
              <div className="justify-start">
                <span className="text-slate-900 text-sm font-medium font-['Inter'] leading-tight">
                  Name
                </span>
                <span className="text-red-600 text-sm font-medium font-['Inter'] leading-tight">
                  *
                </span>
              </div>
              <div className="self-stretch inline-flex justify-start items-start gap-2">
                <div className="flex-1 inline-flex flex-col justify-start items-start gap-1.5">
                  <div className="self-stretch pl-3 pr-14 py-2 bg-white rounded-md outline outline-1 outline-slate-300 inline-flex justify-start items-center">
                    <div className="justify-start text-slate-400 text-base font-normal font-['Inter'] leading-normal">
                      Einsatzname
                    </div>
                  </div>
                </div>
            ...
            <div className="flex-1 inline-flex flex-col justify-start items-start gap-1.5">
              ...
              <div
                ...
                className="self-stretch px-3 py-2 bg-white rounded-md outline outline-1 outline-offset-[-1px] outline-slate-300 inline-flex justify-start items-center gap-2.5"
              >
                <div className="flex-1 justify-start text-slate-800 text-sm font-normal font-['Inter'] leading-normal">
                  Friedhof (FH), Fluchtwege (FW)
                </div>
          ...
          <div className="self-stretch py-2 border-t border-slate-200 flex flex-col justify-start items-start gap-2">
            <div className="px-4 inline-flex justify-center items-center gap-2.5">
              <div className="justify-start text-black text-sm font-semibold font-['Inter'] leading-tight">
                Allgemein
              </div>
            </div>
          ...
          <div className="self-stretch py-2 border-t border-slate-200 flex flex-col justify-start items-start gap-2">
            ...
            <div className="self-stretch flex flex-col justify-start items-start gap-4">
              ...
              <div className="self-stretch px-4 inline-flex justify-start items-start gap-4">
                <div className="flex-1 inline-flex flex-col justify-start items-start gap-1.5">
                  <div className="justify-start text-black text-sm font-medium font-['Inter'] leading-tight">
                    Helfer 1
                  </div>
                  <div
                    data-padding-left="true"
            ...
            <div className="self-stretch py-2 border-t border-slate-200 flex flex-col justify-start items-start gap-2">
              ...
              <div className="self-stretch px-4 inline-flex justify-start items-start gap-4 flex-wrap content-start">
                ...
                <div className="flex-1 h-16 min-w-72 inline-flex flex-col justify-start items-start gap-1.5">
                  ...
                  <div
                    data-state="off"
                    className="flex-1 inline-flex justify-start items-center gap-2"
                  >
                ...
                <div className="flex-1 min-w-[700px] inline-flex flex-col justify-start items-start gap-1.5">
                  <div className="self-stretch flex flex-col justify-start items-start gap-2">
                    <div className="w-28 justify-start text-black text-sm font-medium font-['Inter'] leading-none">
                      Anmerkung
                    </div>
                    <div className="w-[994px] h-20 px-3 py-2 bg-white rounded-md outline outline-1 outline-offset-[-1px] outline-slate-300 inline-flex justify-start items-start gap-2.5">
                      <div className="flex-1 justify-start text-slate-400 text-sm font-normal font-['Inter'] leading-tight">
                        Text hier eingeben ...
                      </div>
                    </div>
                  </div>
          ...
          <div className="self-stretch px-4 flex flex-col justify-start items-start gap-2.5">
            <div
              data-state="Default"
              data-type="with icon"
              className="self-stretch px-4 py-5 bg-slate-50 rounded-md outline outline-1 outline-offset-[-1px] outline-slate-200 inline-flex justify-center items-center gap-2"
            >
              <div className="w-4 h-4 relative overflow-hidden">
