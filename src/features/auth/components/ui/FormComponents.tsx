  ...
  return (
    <div className={`${baseClasses} ${typeClasses[type]} ${className}`}>
      ...
      {onClose && (
        <button
          onClick={onClose}
          className="hover:text-opacity-75 ml-2 text-current transition-opacity"
...
export function Button({
  ...
  const baseClasses =
    'font-medium rounded-md transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center';
